        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50 dark:bg-[#202124] border-b border-gray-200 dark:border-[#3c4043]">
              ...
              <th className="px-4 py-3 font-medium text-xs text-gray-500 dark:text-[#9aa0a6]">Club</th>
              ...
              <tr key={team.team} className="hover:bg-gray-50 dark:hover:bg-[#3c4043] transition-colors">
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  <div className="flex items-center gap-3">
                    <div className={`w-6 h-6 rounded bg-gradient-to-br ${getTeamGradient(team.team)} flex items-center justify-center text-[10px] font-bold text-white shadow-inner`}>
                      {team.team.replace('Batch ', '')}
                    </div>
                    <span className="font-medium text-gray-900 dark:text-[#e8eaed] text-sm">{team.team}</span>
                  </div>
                </td>
